-- Set on fire
--RegisterNetEvent('yh-admin:client:SetOnFire', function(time)
...
--
---- Explode player
--RegisterNetEvent('yh-admin:client:ExplodePlayer', function(damage)
...
--
---- Play Sound
--RegisterNetEvent('yh-admin:client:PlaySound', function(data, selectedData)
...
--
---- Drunk Player
--RegisterNetEvent('yh-admin:client:InitiateDrunkEffect', function()
