...
lib.callback.register('yh-admin:callback:GetResources', function(source)
...
lib.callback.register('yh-admin:callback:ChangeResourceState', function(source, data, perms)
